...
function updateSlides() {
  ...
  if (params.centeredSlides && params.cssMode) {
    uni_modules_zebraUniappSwiperMaster_shared_utils.setCSSProperty(swiper.wrapperEl, "--swiper-centered-offset-before", "");
    uni_modules_zebraUniappSwiperMaster_shared_utils.setCSSProperty(swiper.wrapperEl, "--swiper-centered-offset-after", "");
  }
  ...
  if (params.centeredSlides && params.cssMode && !params.centeredSlidesBounds) {
    uni_modules_zebraUniappSwiperMaster_shared_utils.setCSSProperty(swiper.wrapperEl, "--swiper-centered-offset-before", `${-snapGrid[0]}px`);
    uni_modules_zebraUniappSwiperMaster_shared_utils.setCSSProperty(swiper.wrapperEl, "--swiper-centered-offset-after", `${swiper.size / 2 - slidesSizesGrid[slidesSizesGrid.length - 1] / 2}px`);
